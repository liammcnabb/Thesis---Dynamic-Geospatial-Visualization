...
\documentclass[hyperpdf,twoside]{hepthesis}
...
\begin{mainmatter}
 ...
 \input{ch2-Survey}
 \input{ch3-ChoroplethZooming}
 \input{ch4-UserStudy}
 \input{ch5-MultivariateMaps}
 \input{ch6-SoftwareDevelopment}
...
\begin{appendices}
	\input{AppA-HowToWriteASurveyPaper}
  \input{appendices}
\end{appendices}
